 ...
 */
module.exports = class BmobSocketIo {
  ...
  //取消订阅更新数据表的数据
  unsubUpdateTable = function(tablename) {
    var data = {
      appKey: this.applicationId,
      tableName: tablename,
      objectId: '',
  ...
  //订阅行更新的数据
  updateRow = function(tablename, objectId) {
    var data = {
      appKey: this.applicationId,
      tableName: tablename,
      objectId: objectId,
  ...
  //取消订阅行更新的数据
  unsubUpdateRow = function(tablename, objectId) {
    var data = {
      appKey: this.applicationId,
      tableName: tablename,
      objectId: objectId,
  ...
  //取消订阅表删除的数据
  unsubDeleteTable = function(tablename) {
    var data = {
      appKey: this.applicationId,
      tableName: tablename,
      objectId: '',
  ...
  //订阅更新数据表的数据
  deleteRow = function(tablename, objectId) {
    var data = {
      appKey: this.applicationId,
      tableName: tablename,
      objectId: objectId,
  ...
  //订阅更新数据表的数据
  unsubDeleteRow = function(tablename, objectId) {
    var data = {
      appKey: this.applicationId,
      tableName: tablename,
      objectId: objectId,
  ...
  onUpdateTable = function(tablename, data) {}

  //监听服务器返回的更新数据表的数据，需要用户重写
  onUpdateRow = function(tablename, objectId, data) {}

  //监听服务器返回的更新数据表的数据，需要用户重写
  onDeleteTable = function(tablename, data) {}

  //监听服务器返回的更新数据表的数据，需要用户重写
  onDeleteRow = function(tablename, objectId, data) {}
}
